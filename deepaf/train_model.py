...
"""Train the model on the training data set and validate on test data """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_set', type=str, default='./data/sample_dataset/train.csv', help='Path to train set csv file')
    parser.add_argument('--test_set', type=str, default='./data/sample_dataset/test.csv', help='Path to test set csv file')
