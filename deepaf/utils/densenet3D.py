# -*- coding: utf-8 -*-
"""This code is modified from the DenseNetFCN-3D model implementation from:
https://github.com/GalDude33/DenseNetFCN-3D/blob/master/DenseNet3D.py
"""
...
def DenseNet3DPPI(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
                          ...
                          activation='sigmoid'):
    return DenseNet3D(input_shape, depth=121, nb_dense_block=4, growth_rate=32,
                      nb_filter=64, nb_layers_per_block=[4, 4, 4, 4],
                      bottleneck=bottleneck, reduction=reduction,
                      dropout_rate=dropout_rate, weight_decay=weight_decay,
                      subsample_initial_block=True, include_top=include_top,
                      input_tensor=input_tensor,
...
def __create_dense_net(nb_classes, img_input, include_top, depth=40, nb_dense_block=3,
                       growth_rate=12, nb_filter=-1, nb_layers_per_block=None,
    ...
    with K.name_scope('DenseNet'):
        ...
        if type(nb_layers_per_block) is list or type(nb_layers_per_block) is tuple:
            ...
            if nb_layers_per_block is None:
